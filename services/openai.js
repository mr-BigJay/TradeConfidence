    ...
    messages: [
      {
        role: "system",
        content:
          "You produce strict JSON for a clear practical Persian market-status note. Use the research text as hidden factual base. Explain enough so a normal user understands the situation and what to watch next. Never mention CoinEx/Bitunix/Coinglass or phrases like گزارش پژوهشی / مبتنی بر گزارش / برگرفته از / طبق گزارش. Never invent levels absent from the source. Never give direct buy/sell orders. Keep trading_action = NO_SIGNAL. Always fill simple long_confirm and short_confirm.",
      },
      {
        role: "user",
        content: prompt,
